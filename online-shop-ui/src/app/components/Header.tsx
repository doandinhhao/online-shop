                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        ...
                        >
                            ...
                            >
                                ...
                                <MenuItem value={Lang.FR.toString()}>{getTranslation(lang, "french")}</MenuItem>
                                <MenuItem value={Lang.DE.toString()}>{getTranslation(lang, "german")}</MenuItem>
                                <MenuItem value={Lang.ES.toString()}>{getTranslation(lang, "spanish")}</MenuItem>
                                <MenuItem value={Lang.IT.toString()}>{getTranslation(lang, "italian")}</MenuItem>
                                <MenuItem value={Lang.VI.toString()}>{getTranslation(lang, "vietnam")}</MenuItem>
